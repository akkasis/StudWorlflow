...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex relative">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-8">
            <FieldGroup>
              ...
              <Field>
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-12 bg-card border-border/50 rounded-xl pr-12"
                  />
                  <button
                    type="button"
              ...
              <Button type="submit" className="w-full h-12 rounded-xl glow-primary" disabled={isLoading}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" type="button" className="h-12 rounded-xl border-border/50 bg-card">
      ...
      {/* Right Panel - Visual */}
      <div className="hidden lg:flex flex-1 items-center justify-center bg-card/50 border-l border-border/50 relative overflow-hidden">
        {/* Gradient orbs */}
        ...
        <div className="relative text-center px-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-md mx-auto">
            Join thousands of students helping each other succeed academically.
          </p>
        </div>
      </div>
    </div>
