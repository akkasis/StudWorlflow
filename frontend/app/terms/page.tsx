        ...
        <div className="mx-auto max-w-4xl px-4 py-10">
          <Card>
            ...
            <CardContent className="space-y-6 text-sm leading-7 text-muted-foreground">
              <p>Skillent предоставляет платформу для поиска тьюторов, размещения анкет, общения пользователей и обмена отзывами внутри академической среды.</p>
              ...
              <p>Тьютор самостоятельно отвечает за корректность информации в анкете, описание услуг, стоимость и договоренности, достигнутые с другими пользователями.</p>
