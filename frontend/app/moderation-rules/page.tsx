        ...
        <div className="mx-auto max-w-4xl px-4 py-10">
          <Card>
            ...
            <CardContent className="space-y-6 text-sm leading-7 text-muted-foreground">
              ...
              <p>Стутьютор может получить отметку верификации, если его профиль проверен модерацией. Отзыв может получить отметку подтверждения, если он признан достоверным и полезным для других пользователей.</p>
